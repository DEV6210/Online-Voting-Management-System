                        ...
                        if cd=='Not Generated':
                            ...
                            def give():
                                ...
                                if v3=='BJP' or v3=='TMC' or v3=='Congress':
                                    ...
                                    # auth_token = '62b5f2426eb5ce5ac021ded99f10c6ab'
                                    # client = Client(account_sid, auth_token)
                                    # too='+91'+p
                                    # msg='Online Voting System\nDon't Share OTP\nyour Give vote OTP is: '+motp
                                    # client.messages.create(body=msg,from_='+19704576923',to=too)
            ...
            def verify_ue_otp():
                ...
                if ot==rs_otp:
                    ...
                    def createpdf():   
                        ...
                        # viewcardwin.resizable(False,False)
                        #successfully login  
                        cr.execute(f'select name,dob,gender,father_name,phone,aadhaar,village,post,pin,dist,state,card_no,voting_status from registration where phone={cpn}')
                        data=cr.fetchall()
                        for i in data:
                            n=i[0]
                            d=i[1]
...
# toaster.show_toast("Online Voting Management System", "Thak you for using Our Application/Software...",icon_path='icon/vote-sign.ico',duration=10)
